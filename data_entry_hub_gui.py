...
class DataEntryHubGUI(QMainWindow):
    ...
    def refresh_suppliers_table(self):
        ...
        self.suppliers_table_view.setRowCount(display_df.shape[0])
    ...
    def save_supplier(self):
        ...
        data_dict.update({
            ...
            'ContactPerson': self.sup_contact_edit.text().strip(),
            'Email': self.sup_email_edit.text().strip(),
            'Phone': self.sup_phone_edit.text().strip(),
            'Website': self.sup_website_edit.text().strip(),
